...
public class MainView extends View {
    ...
    public MainView(Context context) {
        ...
        try {
            ...
            Typeface font = ResourcesCompat.getFont(context, R.font.clearsans_bold);
    ...
    private void createBitmapCells() {
        ...
        for (int xx = 1; xx < bitmapCell.length; xx++) {
            ...
            drawDrawable(canvas, ContextCompat.getDrawable(context, cellRectangleIds[xx]), 0, 0, cellSize, cellSize);
            drawCellText(canvas, value);
            bitmapCell[xx] = new BitmapDrawable(context.getResources(), bitmap);
        }
    }
    ...
    private int[] getCellRectangleIds() {
        ...
        cellRectangleIds[13] = R.drawable.cell_rectangle_8192;
        cellRectangleIds[14] = R.drawable.cell_rectangle_16384;
        cellRectangleIds[15] = R.drawable.cell_rectangle_32768;
        cellRectangleIds[16] = R.drawable.cell_rectangle_65536;
        cellRectangleIds[17] = R.drawable.cell_rectangle_131072;
        for (int xx = 17; xx < cellRectangleIds.length; xx++) {
            cellRectangleIds[xx] = R.drawable.cell_rectangle_default;
        }
