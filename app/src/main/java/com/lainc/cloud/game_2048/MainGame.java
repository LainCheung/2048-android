...
public class MainGame {
    ...
    public static final String PREFERENCES_NAME = "game_2048";
    ...
    private void recordHighScore() {
        SharedPreferences settings = mContext.getSharedPreferences(PREFERENCES_NAME,Context.MODE_PRIVATE);
